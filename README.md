...
`c50de6922b00677c93007c01924586de887ced7b@<service-id>` model selected from
the free local `/v1/models` catalog. The current runtime preserves that model
ID and enables native OpenAI tool calls for agent work without a setup probe.
